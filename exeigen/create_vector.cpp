...
Eigen::Vector2d c = Eigen::Vector2d(
    1, 2); // allocated vector with 2 dim with create from contructor
...
int main() {
    ...
    std::cout << "-----------------" << "\n";
    d << 1.2, 21.2, 23.3, 1.2, 21.2, 23.3, 52.0, 1.2, 21.2,
        23.3; // assigning value to vector with << operator
    std::cout << d << std::endl;
