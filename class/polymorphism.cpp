...
class Employee {
    ...
    public:
        ...
        virtual void work() { // declare a general member method.
                              // polymorphism : must have the same name of method for every child class,
                              // use virtual is importance. it say that if the child class does not have this method, use the default one from super class, otherwise use their own method.
