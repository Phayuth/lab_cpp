...
joint12 = np.loadtxt("_projects/_paper_mobile_manipulator/build/paper_mm_simple_path.csv", delimiter=",")
...
for i in range(numjoints):
    axs[i].plot(time, joint12[:, i], color="blue", marker="o", linestyle="dashed", linewidth=2, markersize=6, label=f"Joint Pos {i+1}")
