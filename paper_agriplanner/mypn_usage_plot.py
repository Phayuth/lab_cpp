...
graph = nx.read_graphml("./paper_agriplanner/build/zzz_planner_data.graphml")
path = np.loadtxt("./paper_agriplanner/build/zzz_path.csv", delimiter=",")
state = np.loadtxt("./paper_agriplanner/build/zzz_start_goal.csv", delimiter=",")
